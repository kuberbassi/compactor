...
export const TOOL_ROUTES: ToolRoute[] = [
  route('video-compressor', '/video/compress', 'Compress Video', 'Reduce video file size privately in your browser.'),
  route('video-to-audio', '/video/audio', 'Video to Audio', 'Extract an audio track from a video privately.'),
  ...
  route('video-trim', '/video/trim', 'Trim Video', 'Cut unwanted sections from a video privately in your browser.'),
  route('video-convert', '/video/convert', 'Convert Video', 'Convert a video to another supported format privately in your browser.'),
  ...
  route('image-watermark', '/image/watermark', 'Watermark Images', 'Add a custom text watermark to images privately in your browser.'),
