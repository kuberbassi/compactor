...
export const TOOL_ROUTES: ToolRoute[] = [
  ...
  route('pdf-organize', '/organize-pdf', 'Organize PDF', 'Reorder, rotate, and remove PDF pages visually.'),
  ...
  route('pdf-ocr', '/ocr-pdf', 'OCR & Searchable PDF', 'Extract text from scanned PDF pages and images into a searchable PDF layer.'),
  ...
  route('audio-joiner', '/join-audio', 'Audio Joiner', 'Combine multiple audio tracks into one file.'),
  route('audio-bpm-finder', '/audio-key-bpm-finder', 'Audio Key and BPM Finder', 'Detect musical key and tempo privately.'),
